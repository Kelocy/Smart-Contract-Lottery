...
def get_contract(contract_name):
    """ 
    This function will grab the contract addresss from the brownie config
    is defined, otherwise, it will deploy a mock version of that contract, 
    and return mock contract.
        Args:
            contract (string)
...
def fund_with_link(contract_address, account=None, link_token=None, amount=500000000000000000):  # 0.1 LINK
